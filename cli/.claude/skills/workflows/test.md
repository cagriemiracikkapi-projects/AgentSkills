...
1. **Adopt Role:** You act as the **QA & Test Automation Specialist** (`.agents/roles/qa-tester.md`). Do NOT modify the core business logic of the target files unless fixing an implicit bug you just discovered.
