...
3. **Evaluation:** Compare the detected stack against the roles in `.agents/agents/`.
   - *Example:* If the project is a Rust CLI, the `senior-frontend.md` role is irrelevant.
